    ...
    <div className="container mb-5 border">
      <div className="d-flex align-items-center mt-3">
        <input
          ...
          onChange={(e) => setQuestionTitle(questionIndex, e.target.value)}
        />
        <select
          name="questionType"
          ...
          value={question.type}
          onChange={(e) => setQuestionType(questionIndex, e.target.value)}
        >
        ...
        <div className="d-flex align-items-center">
          ...
          <input
            ...
            onChange={(e) =>
              setQuestionPoints(questionIndex, parseInt(e.target.value, 10))
            }
          />
        </div>
      </div>
